...
if plot_brain_peakCluster == 1
    ...
    for ss = 1:length(sublist)
        ...
        [~,~,sfs_cordsOUT_2] = convertLepto2FS_LR(sbj_short, lepto_cord_out, Msurf2space,  wbDir, brainDir,999); % radius = 999 --> use all surface projectsions
        [~,~,sfs_cordsIN_2] = convertLepto2FS_LR(sbj_short, lepto_cord_in, Msurf2space,  wbDir, brainDir,999);
    ...
    for p = 1:length(paths)
        ...
        for c = 1:3
            ...
            %--------------------------------------------------------------------------------------------------
            figname = sprintf('BrainHeatMap CCEP %s cluster%d %d-%dms_median2.jpg', path, c, trange(1), trange(2));
            %output_folder = [];
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
