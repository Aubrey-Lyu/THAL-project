...
if plot_brain_peakCluster == 1
    ...
    for p = 1:length(paths)
        ...
        if strcmp(path, 'outflow')
            MNI = [metaT.MNIin_coord_1 metaT.MNIin_coord_2 metaT.MNIin_coord_3];
        else
        ...
        for c = 1:3
            ...
            %--------------------------------------------------------------------------------------------------
            figname = sprintf('BrainHeatMap CCEP %s cluster%d %d-%dms_median.jpg', path, c, trange(1), trange(2));
            %output_folder = [];
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            plotBrainSurfaceWeight(cmcortex , coordinates_cell, weights_cluster, 1, jplabel_cell, output_folder, anot, pers_rule, cfg,figname);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        end % for cluster
    end % for path
    toc
